...
def glowscript(line, cell):
    ...
    if (len(lst) == 0) or (lst[-1] in ['vpython','rapydscript','coffeescript','javascript']) :
        ...
        if (window.location.protocol === 'https:') {
            require(['https://cdnjs.cloudflare.com/ajax/libs/acorn/3.2.0/acorn.min.js','https://dl.dropboxusercontent.com/u/5095342/glowscript/lib/jquery/2.1/jquery-ui.custom.min.js','https://cdn.rawgit.com/BruceSherwood/glowscript/master/package/compiler.2.1.min.js','https://dl.dropboxusercontent.com/u/5095342/glowscript/package/symbols.2.1.min.js','https://dl.dropboxusercontent.com/u/5095342/glowscript/package/RSrun.2.1.min.js','http://cdn.rawgit.com/BruceSherwood/glowscript/master/package/RScompiler.2.1.min.js','https://cdn.rawgit.com/BruceSherwood/glowscript/master/package/glow.2.1.min.js'], function(acorn) {
            window.acorn = acorn;
            ...
            require(['http://cdnjs.cloudflare.com/ajax/libs/acorn/3.2.0/acorn.min.js','http://www.glowscript.org/lib/jquery/2.1/jquery.min.js','http://www.glowscript.org/lib/jquery/2.1/jquery-ui.custom.min.js','https://cdn.rawgit.com/BruceSherwood/glowscript/master/package/compiler.2.1.min.js','http://www.glowscript.org/package/symbols.2.1.min.js','http://www.glowscript.org/package/RSrun.2.1.min.js','http://cdn.rawgit.com/BruceSherwood/glowscript/master/package/RScompiler.2.1.min.js','http://cdn.rawgit.com/BruceSherwood/glowscript/master/package/glow.2.1.min.js'], function(acorn) {
            window.acorn = acorn;
            var cell_content = """+json.dumps(cell)+""";
            var embedScript = window.glowscript_compile(cell_content, {lang:'"""+lang+"""'}); 
            ...
            require(['http://cdnjs.cloudflare.com/ajax/libs/acorn/3.2.0/acorn.min.js','http://www.glowscript.org/lib/jquery/2.1/jquery-ui.custom.min.js','https://cdn.rawgit.com/BruceSherwood/glowscript/master/package/compiler.2.1.min.js','http://www.glowscript.org/package/symbols.2.1.min.js','http://www.glowscript.org/package/RSrun.2.1.min.js','http://cdn.rawgit.com/BruceSherwood/glowscript/master/package/RScompiler.2.1.min.js','http://cdn.rawgit.com/BruceSherwood/glowscript/master/package/glow.2.1.min.js'], function(acorn) {
            window.acorn = acorn;
            var cell_content = """+json.dumps(cell)+""";
            var embedScript = window.glowscript_compile(cell_content, {lang:'"""+lang+"""'}); 
            embedScript = "require(['http://www.glowscript.org/lib/jquery/2.1/jquery-ui.custom.min.js','http://www.glowscript.org/package/glow.2.1.min.js'], function() {" + embedScript + ";$(function(){ window.__context = { glowscript_container: $('#glowscript').removeAttr('id') }; main() });})";
